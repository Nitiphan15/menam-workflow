...
class PoExportController extends Controller
{
    ...
    private function overlaySignatures(Fpdi $pdf, array $signatures, float $pageWidth, float $pageHeight, array &$tempImages): void
    {
        ...
        $this->overlaySignatureSlot($pdf, $authorizedBy, 0.39 * $pageWidth, 0.863 * $pageHeight, 0.22 * $pageWidth, 0.052 * $pageHeight, 0.955 * $pageHeight, $tempImages, strokeBoost: 0.18, trimTransparent: true);
    }
