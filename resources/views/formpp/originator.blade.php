...
@section('content')
    ...
    <div class="container py-3">
        ...
        @if ($result)
                ...
                <div class="col-md-3">
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-body">
                            ...
                            <div class="fw-semibold">{{ $result['type_desc'] ?? '-' }}</div>
            ...
            <form method="POST" action="{{ route('pp.store') }}" id="originatorForm" class="mb-4">
                @csrf
                ...
                @endforeach
                {{-- <input type="text" name="customer" value="{{ $selectedCustomer }}">  --}}
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="p-3">
                            ...
                            <div class="mt-2">
                                ...
                                <textarea id="reject_reason" name="reason" class="form-control mb-2" placeholder="" rows="2"></textarea>
                            ...
                            <button type="button" id="exportBtn" class="btn btn-success">
                                <i class="fas fa-file me-1"></i> Export CSV
                            </button>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm table-bordered align-middle">
                                ...
                                <tbody>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="11" class="text-center text-muted">ไม่มีข้อมูล FG</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
                            ...
                            <div>
                                <div class="text-muted small">ข้อมูลในตาราง FG เป็นการรวมของ Plus และ Wire แยกตามลูกค้า
                                </div>
                            </div>
                        </div>
...
@push('scripts')
    <script>
        ...
        document.getElementById('originatorForm')?.addEventListener('submit', function(e) {
