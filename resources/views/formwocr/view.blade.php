    ...
    <div class="sheet">
        ...
        <form method="POST" action="{{ $action }}">
            ...
            <div class="head-bar mb-3">
                ...
                <div class="form-no">Form No: <input name="form_no" readonly value="{{ old('form_no', $form->form_no ?? '') }}"
            ...
            <div class="row g-3 mb-2  sig-row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <div class="row g-2 align-items-center">
                        ...
                        <div class="col-9"><input name="approver_name" class="form-control" readonly
                                value="{{ old('approver_name', $firstApprove->actor_name ?? '') }}"></div>
                        <div class="col-3 text-end">วันที่ :</div>
                        <div class="col-9"><input name="approver_date" class="form-control" readonly
                                value="{{ old('approver_date', $firstApprove->created_at ?? '') }}"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="card shadow-sm h-100">
                    ...
                    <div class="card-body text-center">
                        <img src="{{ asset("formwocr/{$currentStep}.png") }}"
